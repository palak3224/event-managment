              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <a href="mailto:info@khaoKhilaoSonedo.in" className="text-white/70 hover:text-white transition-colors">
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-16 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-3">
                <div className="golden-bg rounded-full flex items-center justify-center">
            <img src="/logo.png" alt="KKH Logo" className="h-16 md:h-24 w-auto object-contain" />

                </div>
                <div>
                  <h4 className="golden texturina text-lg font-semibold">KHAO</h4>
                  <p className="text-white/50 text-xs">KHILAO SONE DO</p>
                </div>
              </div>
