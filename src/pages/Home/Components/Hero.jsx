...
const SmoothScrollHero = () => {
  return (
      ...
      backgroundImage: 'radial-gradient(circle, rgba(106, 13, 173, 0.4) 1.4px, transparent 1.4px)',
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-96 bg-gradient-to-b from-purple-300/0 to-purple-300" />
    </div>
  );
};
